 ...
 <div class="container">
      ...
      <div class="nav-scroller py-1 mb-2">
        <nav class="nav d-flex justify-content-between"> 
          <a class="p-2 text-muted" href="#"><a class="p-2 text-muted" href="#" spellcheckker="false"
              style="color: black; background-color:#e2ecef;">Corona regulations</a></a>
          
          <a class="p-2 text-muted" href="#">List of sports clubs</a>
       
          <a class="p-2 text-muted" href="#"><a class="p-2 text-muted" href="#" spellcheckker="false"
              style="color: #ccc;background-color:  #e2ecef;">List of devices</a></a>
